...
import { OldClubNameDto } from "./entities/old-club-name.dto";
...
export class ClubController {
  ...
  public updateClub(@Body() body: Club): Promise<Club> {
    return this.service.updateClub(body);
  }
  ...
  public createClub(@Body() body: CreateClubDto): Promise<Club> {
